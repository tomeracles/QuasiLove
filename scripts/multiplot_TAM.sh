...
get_stuff() {
    ...
    alllist=$(grep _G.TAM$ ./Africa/logfile.txt | awk '{print $1}')
    glist=$(grep _G.TAM. ./Africa/results/logfile.txt | awk '$2==1{print $1}')

    grep _G.TAM. ./Africa/results/logfile.txt | awk '{print $1}' | head
...
plot_sac() {
    gmt begin tmp/tmp
        gmt basemap -JX10/25 -R-200/550/320/360 -BWrnS \
